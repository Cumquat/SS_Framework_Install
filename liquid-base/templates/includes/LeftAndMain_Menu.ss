<div class="cms-menu cms-panel cms-panel-layout west" id="cms-menu" data-layout-type="border">
	<div class="cms-logo-header north">
		<div class="cms-logo">
			<a href="http://www.liquid-computing.co.uk" target="_blank" title="LC Systems (Version - $CMSVersion)">
				LC System <% if $CMSVersion %><abbr class="version">$CMSVersion</abbr><% end_if %>
			</a>
			<span><% if $SiteConfig %>$SiteConfig.Title<% else %>LC System<% end_if %></span>
		</div>
